...
global conn, cursor
conn= connector.connect(host="localhost",database="pos",user="root",password="root")
cursor = conn.cursor()
...
def billing():
    ...
    print('                     D- Block Chander Nagar, Pune     ')
    print('                     Phone: 8830915689, Email: priyabhoite2912@gmail.com ')
